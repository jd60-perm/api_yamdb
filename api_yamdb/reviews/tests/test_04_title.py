...
class Test04TitleAPI:
    ...
    def test_02_title_admin(self, admin_client):
        ...
        assert Category.objects.get(slug='films'), ('YYYYYYYYYYYYYYY')
        # assert Genre.objects.get(slug=genres[1]['slug']), ('YYYYYYYYYYYYYYY')
        assert categories[0]['slug'] == 'films', ('YYYYYYYYYYYYYYY')
